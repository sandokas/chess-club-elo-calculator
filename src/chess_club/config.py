...
def reload() -> None:
	...
	global DB_PATH, G2_DEFAULT_RATING, G2_DEFAULT_RD, G2_DEFAULT_VOL
	...
	G2_DEFAULT_RATING = _OPERATIONAL["G2_DEFAULT_RATING"]
	G2_DEFAULT_RD = _OPERATIONAL["G2_DEFAULT_RD"]
	G2_DEFAULT_VOL = _OPERATIONAL["G2_DEFAULT_VOL"]
